...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESP_WIFI_MAX_THREAD_PRIORITY, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESP32_WIFI_TIMER_TASK_PRIO, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOTLOADER_SRAM_SIZE, 0);
